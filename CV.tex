...
\cventry{} {Juillet 2018-Aujourd'hui} {Alternance} {HU\&CO} {Saint Jean D'Illac} {
	Développement et intregation d'applications sur un environnement linux embarqué pour un système d'alarme
	\begin{itemize}
		...
		\begin{itemize}
			\item I$^{2}$C
			\item Application sous Python 3.7
		\end{itemize}
		\item Développement du firmware des periphériques sous Chip CC1310
...
\cvitem {SOC:} {Broadcom BCM2837/35, NXP i.MX7, NXP LS1012} 
...
\cvitem {MCU:} {HCS08(Freescale), ARM Cortex M4/M0/M3}
